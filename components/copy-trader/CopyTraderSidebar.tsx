...
export default function CopyTraderSidebar({
  isOpen,
  isCollapsed,
  isMobile,
  onToggle,
      ...
      >
        ...
        <div className="mt-4 px-4 space-y-3">
          <button
            ...
            title={isCollapsed && !isMobile ? "Exchange Settings" : undefined}
            className={`
          ...
          >
            ...
            {(!isCollapsed || isMobile) && <span>Exchange Settings</span>}
          </button>
          ...
          <button
            ...
            className={`
              ...
              text-slate-300 hover:text-tertiary font-bold text-sm
