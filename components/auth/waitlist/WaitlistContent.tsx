          ...
          <div className="space-y-3">
            ...
            {isAuthenticated ? (
              <button
                ...
                disabled={isLoading}
                className="w-full py-3.5 mt-3 px-4 rounded-xl border border-[var(--color-outline)]/20 text-[var(--color-on-surface)] font-semibold hover:bg-[var(--color-surface-container-highest)] transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <Link
                href="/login"
                className="w-full mt-3 border border-outline/20 text-(--color-on-surface) font-semibold py-3.5 rounded-xl hover:bg-(--color-surface-container-highest) active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-60"
              >
                <span>Sign In</span>
                <RiArrowRightLine className="text-lg" />
              </Link>
